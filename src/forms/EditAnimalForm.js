...
const EditAnimalForm = (props) => {
    ...
    const handleSubmit = e => {
        e.preventDefault();
        if (animal.name && animal.type && animal.eatingHabits && animal.extinction) props.updateAnimal(animal);
    }
    ...
    return (
        <form>
            ...
            <input className="u-full-width" type="text" value={animal.eatingHabits} name="type" onChange={handleChange} />
            <label>Extinction Status</label>
            <input className="u-full-width" type="text" value={animal.extinction} name="type" onChange={handleChange} />
